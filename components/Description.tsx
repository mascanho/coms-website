...
function Description() {
  return (
    <div className="bg-white pb-2  z-10 relative sm:rounded-b-[200px] rounded-b-[100px]">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:py-24">
              ...
              <p className="mt-4 text-gray-600">
                Crossed Lines was created by a group of Engineers and
                Technicians with more than 20 years of experience in new
                generation network telecommunications and who decided to join
                their experiences to create a telecommunications brand across
                Europe.{" "}
              </p>
